...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  type: 'sparkles' | 'copy' | 'loader' | 'rocket' | 'reset' | 'sun' | 'moon' | 'desktop' | 'flagId' | 'flagEn' | 'flagSa' | 'flagCn' | 'flagRu' | 'history' | 'tiktok' | 'youtube' | 'trash' | 'user' | 'key' | 'logout' | 'help' | 'lightbulb';
}
